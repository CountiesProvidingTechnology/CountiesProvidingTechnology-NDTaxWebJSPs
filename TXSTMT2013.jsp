...
String table=("TXSTMT"+cidp+"13");



// Set path based on county id parameter path control color -------------------------------


// ORANGE-Douglas/Meeker/Redwood/Rock/Swift
if ( (cidp.equals("21")) || (cidp.equals("47")) || (cidp.equals("64")) || (cidp.equals("67")) || (cidp.equals("76")) ) {
	readerpath=("/reports/TAXSTMT2013165.pdf");
}


// BLUE-Grant/Mille Lacs/Norman/Renville
if ( (cidp.equals("26")) || (cidp.equals("48")) || (cidp.equals("54")) || (cidp.equals("65")) ) {
	readerpath=("/reports/TAXSTMT2013300.pdf");
}


// GREEN-Kandiyohi/Nobles/Red Lake/Yellow Medicine
if ( (cidp.equals("34")) || (cidp.equals("53")) || (cidp.equals("63")) || (cidp.equals("87")) ) {
	readerpath=("/reports/TAXSTMT2013354.pdf");
}


// PINK-Lincoln
if (cidp.equals("41")) {
	readerpath=("/reports/TAXSTMT2013RHR.pdf");
}


// PURPLE-Lyon/Marshall/Stevens/Wilkin
if ( (cidp.equals("42")) || (cidp.equals("45")) || (cidp.equals("75")) || (cidp.equals("84")) ) {
	readerpath=("/reports/TAXSTMT2013266.pdf");
}


// MAROON-Murray/Pope
if ( (cidp.equals("51")) || (cidp.equals("61")) ) {
	readerpath=("/reports/TAXSTMT2013208.pdf");
}


// RED-Steele
if  (cidp.equals("74")) {
	readerpath=("/reports/TAXSTMT2013185.pdf");
}


// TEAL-Travers
if  (cidp.equals("78")) {
	readerpath=("/reports/TAXSTMT2013321.pdf");
}


// BROWN-Todd
if (cidp.equals("77")) {
	readerpath=("/reports/TAXSTMT2013471.pdf");
}


// COUNTY-Wadena
if (cidp.equals("80")) {
	readerpath=("/reports/TAXSTMT2013C80.pdf");
}
...
Connection con1 = DriverManager.getConnection("jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ=c:\\Inetpub\\wwwroot\\Tax\\Data\\cntyname.mdb");
...
//PdfReader reader = new PdfReader(request.getRealPath("/reports/TAXSTMT2012.pdf"));
...
AcroFields form = stamper.getAcroFields();
 ...
 while (rs.next()) {
 	...
 	String escrowwords=rs.getString(118);
 	...
 	String lyhsam2=rs.getString(25);
 	String hseamt2=rs.getString(26);
 	...
 	String duedate2="";
 	String xduedate=rs.getString(128);
 	
 	if (xduedate==None) {
		duedate2="";
	}
	else {
		duedate2=xduedate.trim()+" "+year;
 	}
...
//If Grant or Stevens print market referendum value	
	 String xtt1mkt2=rs.getString(138);
	 if ( (cidp.equals("26")) || (cidp.equals("75")) ) {
	 	tt1mkt2=xtt1mkt2;
	 }
	 else {
	 	tt1mkt2="";
...
//Fill PDF Form Fields by Line
	...
	form.setField("TOTLES2", rs.getString(31));
   	...
   	form.setField("IMPREXCL",imprexcl);
   	form.setField("LYHSAM2", lyhsam2);
	form.setField("HSEAMT2", hseamt2);
   	
   	form.setField("PDESC3",rs.getString(13)); 
   	form.setField("LYHMSTEXCL",rs.getString(136));
   	form.setField("HMSTEXCL",rs.getString(135));
	...
	form.setField("MKTTAX1", rs.getString(105));
