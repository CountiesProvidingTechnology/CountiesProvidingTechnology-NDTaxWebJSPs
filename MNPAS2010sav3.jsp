...
p2.add(new Paragraph("2012 ASSESSMENT FOR TAX PAYABLE IN 2013",headFont));
...
p3.add(new Paragraph("The 2012 assessment reflects the property value as of January 2nd, 2012 using sales that occurred between October 2010 and",secondFont));
document.add(p3);

Paragraph p4 = new Paragraph();
p4.add(new Paragraph("September 2011.  Buildings built prior to January 2nd, 2012 or buildings which were partially complete as of January 2nd, 2012",secondFont));
document.add(p4);

Paragraph p5 = new Paragraph();
p5.add(new Paragraph("are included here.  Any buildings built after January 2nd, 2012 will be included on the January 2nd, 2013 assessment.",secondFont));
document.add(p5);
...
//TABLE E ----------------------------------------------------------------------------
	...
	PdfPCell celle13=new PdfPCell(new Paragraph("Exempt Wetlands",secondFont));
