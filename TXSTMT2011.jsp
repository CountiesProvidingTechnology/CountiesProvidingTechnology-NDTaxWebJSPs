...
String query1=" SELECT * FROM [CNTYDATA11] ";
query1+=" WHERE ((([CNTYDATA11].SYCNTY)='"+cidp+"'))";
...
PdfReader reader = new PdfReader(request.getRealPath("/reports/TAXSTMT2011.pdf"));
