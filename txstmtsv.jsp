...
String query=" SELECT * FROM [CNTYDATA] ";
query+=" WHERE ((([CNTYDATA].SYCNTY)='"+cidp+"'))";
 ...
 if (rs.next()) {
	syline1=rs.getString(2);
	syline2=rs.getString(3);
	syline3=rs.getString(4);
	syline4=rs.getString(5);
	syline5=rs.getString(6);
	syline6=rs.getString(7);
...
//String query="SELECT [Table 1 - Name/Addr/Desc/Tax/Recap Info].TXPRCL, [Table 1 - Name/Addr/Desc/Tax/Recap Info].TXYEAR, [Table 1 - Name/Addr/Desc/Tax/Recap Info].TXTNAM, [Table 1 - Name/Addr/Desc/Tax/Recap Info].TXTAD1,[Table 1 - Name/Addr/Desc/Tax/Recap Info].TXEVAL ,[Table 1 - Name/Addr/Desc/Tax/Recap Info].HALF1,[Table 1 - Name/Addr/Desc/Tax/Recap Info].HALF2,[Table 1 - Name/Addr/Desc/Tax/Recap Info].TXLIMK,[Table 1 - Name/Addr/Desc/Tax/Recap Info].TXASMD,[Table 1 - Name/Addr/Desc/Tax/Recap Info].TXSECT,[Table 1 - Name/Addr/Desc/Tax/Recap Info].TXTOWN,[Table 1 - Name/Addr/Desc/Tax/Recap Info].TXRANG,[Table 1 - Name/Addr/Desc/Tax/Recap Info].TXDSC1,[Table 1 - Name/Addr/Desc/Tax/Recap Info].TXDSC2";
//String query=" SELECT * FROM [Table 1 - Name/Addr/Desc/Tax/Recap Info] ";



query=" SELECT * FROM [TXSTMT] ";
query+=" WHERE ((([TXSTMT].Field2)='"+parcelp+"') AND (([TXSTMT].Field1)='"+yearp+"'))";
...
%>
<form action="/iText/reports/new.pdf">
