...
String asyp=request.getParameter("asy");


//Develop Dates - It is assumed that the asy parameter is the assessment year

int AssessmentYear=Integer.parseInt(asyp);
int PayableYear=(AssessmentYear+1);
int SaleYear1=(AssessmentYear-2);
int SaleYear2=(AssessmentYear-1);
int BuiltYear1=AssessmentYear;
int BuiltYear2=AssessmentYear;
int BuiltYear3=AssessmentYear;
int FutureYear=(AssessmentYear+1);
...
p2.add(new Paragraph(""+AssessmentYear+" ASSESSMENT FOR TAX PAYABLE IN "+PayableYear+"",headFont));
...
p3.add(new Paragraph("The "+AssessmentYear+" assessment reflects the property value as of January 2nd, "+AssessmentYear+" using sales that occurred between October "+SaleYear1+" and",secondFont));
document.add(p3);

Paragraph p4 = new Paragraph();
p4.add(new Paragraph("September "+SaleYear2+".  Buildings built prior to January 2nd, "+BuiltYear1+" or buildings which were partially complete as of January 2nd, "+BuiltYear2+"",secondFont));
document.add(p4);

Paragraph p5 = new Paragraph();
p5.add(new Paragraph("are included here.  Any buildings built after January 2nd, "+BuiltYear3+" will be included on the January 2nd, "+FutureYear+" assessment.",secondFont));
document.add(p5);
...
//System.out.println("QUERY2 IS "+query2);  
 ...
 if (rs2.next()) {
 	...
 	float totwet=rs2.getFloat(28);
 	float totrrlp=rs2.getFloat(29);
 	float totexcl=rs2.getFloat(30);
 	float totrmkv=rs2.getFloat(31);
...
//Total Value
 ...
 //Total Wetlands
	if (totwet==0) {
		...
		xtotwet=df1.format(totwet);
	}
 		 	
 //Total Rural Preserve
	if (totrrlp==0) {
		xtotrrlp="";
	}
	else {
		xtotrrlp=df1.format(totrrlp);
	}
...
//TABLE E ----------------------------------------------------------------------------
	...
	PdfPCell celle13=new PdfPCell(new Paragraph("Exempt Wetlands/Native Prarie",secondFont));
	PdfPCell celle23=new PdfPCell(new Paragraph(xtotwet,secondFont));
	...
	PdfPCell celle14=new PdfPCell(new Paragraph("Green Acres Value Def.",secondFont));
	...
	PdfPCell celle1a=new PdfPCell(new Paragraph("Rural Pres. Value Deferred",secondFont));
	PdfPCell celle2a=new PdfPCell(new Paragraph(xtotrrlp,secondFont));
	PdfPCell celle3a=new PdfPCell(new Paragraph("# of Units",secondFont));
	PdfPCell celle4a=new PdfPCell(new Paragraph(" "));
	celle1a.setBorder(Rectangle.NO_BORDER);
	celle2a.setBorder(Rectangle.NO_BORDER);
	celle3a.setBorder(Rectangle.NO_BORDER);
	celle4a.setBorder(Rectangle.NO_BORDER);
	celle1a.setHorizontalAlignment(Element.ALIGN_LEFT);
	celle2a.setHorizontalAlignment(Element.ALIGN_RIGHT);
	celle3a.setHorizontalAlignment(Element.ALIGN_RIGHT);
	celle4a.setHorizontalAlignment(Element.ALIGN_RIGHT);
	tablee.addCell(celle1a);
	tablee.addCell(celle2a);
	tablee.addCell(celle3a);
	tablee.addCell(celle4a);
	...
	PdfPCell celle35=new PdfPCell(new Paragraph("Total Sq Ft",secondFont));
	PdfPCell celle45=new PdfPCell(new Paragraph(xsqft,secondFont));
	...
	PdfPCell celle16=new PdfPCell(new Paragraph("JOBZ Amount Exempted",secondFont));
	PdfPCell celle26=new PdfPCell(new Paragraph(xtotjobz,secondFont));
	PdfPCell celle36=new PdfPCell(new Paragraph("Year Built",secondFont));
	PdfPCell celle46=new PdfPCell(new Paragraph(xyrbuilt,secondFont));
	...
	PdfPCell celle37=new PdfPCell(new Paragraph("Year Remdl",secondFont));
	PdfPCell celle47=new PdfPCell(new Paragraph(xyrremodel,secondFont));
	...
	PdfPCell celle18=new PdfPCell(new Paragraph("Dis Vets Mkt. Value Excl.",secondFont));
	PdfPCell celle28=new PdfPCell(new Paragraph(xtotvets,secondFont));
	PdfPCell celle38=new PdfPCell(new Paragraph("Air Cond",secondFont));
	PdfPCell celle48=new PdfPCell(new Paragraph(aircond,secondFont));
	...
	PdfPCell celle1b=new PdfPCell(new Paragraph("Homestead Mkt. Value Excl.",secondFont));
	PdfPCell celle2b=new PdfPCell(new Paragraph(xtotexcl,secondFont));
	PdfPCell celle3b=new PdfPCell(new Paragraph(" "));
	PdfPCell celle4b=new PdfPCell(new Paragraph(" "));
	celle1b.setBorder(Rectangle.NO_BORDER);
	celle2b.setBorder(Rectangle.NO_BORDER);
	celle3b.setBorder(Rectangle.NO_BORDER);
	celle4b.setBorder(Rectangle.NO_BORDER);
	celle1b.setHorizontalAlignment(Element.ALIGN_LEFT);
	celle2b.setHorizontalAlignment(Element.ALIGN_RIGHT);
	celle3b.setHorizontalAlignment(Element.ALIGN_RIGHT);
	celle4b.setHorizontalAlignment(Element.ALIGN_RIGHT);
	tablee.addCell(celle1b);
	tablee.addCell(celle2b);
	tablee.addCell(celle3b);
	tablee.addCell(celle4b);
	...
	PdfPCell celle39=new PdfPCell(new Paragraph(" "));
	PdfPCell celle49=new PdfPCell(new Paragraph(" "));
	...
	PdfPCell celle1c=new PdfPCell(new Paragraph("New Improvements included in Est. Mkt.",secondFont));
	PdfPCell celle2c=new PdfPCell(new Paragraph(xtotimpv,secondFont));
	PdfPCell celle3c=new PdfPCell(new Paragraph(" "));
	PdfPCell celle4c=new PdfPCell(new Paragraph(" "));
	celle1c.setBorder(Rectangle.NO_BORDER);
	celle2c.setBorder(Rectangle.NO_BORDER);
	celle3c.setBorder(Rectangle.NO_BORDER);
	celle4c.setBorder(Rectangle.NO_BORDER);
	celle1c.setHorizontalAlignment(Element.ALIGN_LEFT);
	celle2c.setHorizontalAlignment(Element.ALIGN_RIGHT);
	celle3c.setHorizontalAlignment(Element.ALIGN_RIGHT);
	celle4c.setHorizontalAlignment(Element.ALIGN_RIGHT);
	tablee.addCell(celle1c);
	tablee.addCell(celle2c);
	tablee.addCell(celle3c);
	tablee.addCell(celle4c);
	
	
	PdfPCell celle1d=new PdfPCell(new Paragraph("Referendum Market Value",secondFont));
	PdfPCell celle2d=new PdfPCell(new Paragraph(xtotrmkv,secondFont));
	PdfPCell celle3d=new PdfPCell(new Paragraph(" "));
	PdfPCell celle4d=new PdfPCell(new Paragraph(" "));
	celle1d.setBorder(Rectangle.NO_BORDER);
	celle2d.setBorder(Rectangle.NO_BORDER);
	celle3d.setBorder(Rectangle.NO_BORDER);
	celle4d.setBorder(Rectangle.NO_BORDER);
	celle1d.setHorizontalAlignment(Element.ALIGN_LEFT);
	celle2d.setHorizontalAlignment(Element.ALIGN_RIGHT);
	celle3d.setHorizontalAlignment(Element.ALIGN_RIGHT);
	celle4d.setHorizontalAlignment(Element.ALIGN_RIGHT);
	tablee.addCell(celle1d);
	tablee.addCell(celle2d);
	tablee.addCell(celle3d);
	tablee.addCell(celle4d);
