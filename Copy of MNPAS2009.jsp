...
String sketch=xparcel+"0101.jpg";
...
p2.add(new Paragraph("2010 ASSESSMENT FOR TAX PAYABLE IN 2011",headFont));
...
p3.add(new Paragraph("The 2010 assessment reflects the property value as of January 2nd, 2010 using sales that occurred in the previous",secondFont));
document.add(p3);

Paragraph p4 = new Paragraph();
p4.add(new Paragraph("year.  Buildings built prior to January 2nd, 2010 or buildings which were partially complete as of January 2nd, 2010",secondFont));
document.add(p4);

Paragraph p5 = new Paragraph();
p5.add(new Paragraph("are included here.  Any buildings built after January 2nd, 2010 will be included on the January 2nd, 2011 assessment.",secondFont));
document.add(p5);
...
//Check if Alternate mailing information should be printed	
	...
	PdfPCell celld110=new PdfPCell(new Paragraph("Property Classification",F10B));
	PdfPCell celld210=new PdfPCell(new Paragraph(" ",F10B));
	PdfPCell celld310=new PdfPCell(new Paragraph("Property Address",F10B));
	celld110.setBorder(Rectangle.NO_BORDER);
	celld210.setBorder(Rectangle.NO_BORDER);
	celld310.setBorder(Rectangle.NO_BORDER);
	celld110.setBackgroundColor(Color.LIGHT_GRAY);
	celld310.setBackgroundColor(Color.LIGHT_GRAY);
	celld110.setHorizontalAlignment(Element.ALIGN_LEFT);
	tabled.setHorizontalAlignment(Element.ALIGN_LEFT);
	tabled.addCell(celld110);
	tabled.addCell(celld210);
	tabled.addCell(celld310);
...
//System.out.println("ESTIMATED MARKET VALUE "+totmkv);


	PdfPCell celld111=new PdfPCell(new Paragraph(asmt1,secondFont));
	PdfPCell celld211=new PdfPCell(new Paragraph(" ",secondFont));
	PdfPCell celld311=new PdfPCell(new Paragraph(propertyaddress,secondFont));
	celld111.setBorder(Rectangle.NO_BORDER);
	celld211.setBorder(Rectangle.NO_BORDER);
	celld311.setBorder(Rectangle.NO_BORDER);
	celld111.setHorizontalAlignment(Element.ALIGN_LEFT);
	tabled.setHorizontalAlignment(Element.ALIGN_LEFT);
	tabled.addCell(celld111);
	tabled.addCell(celld211);
	tabled.addCell(celld311);

	PdfPCell celld112=new PdfPCell(new Paragraph(asmt2,secondFont));
	PdfPCell celld212=new PdfPCell(new Paragraph(" ",secondFont));
	PdfPCell celld312=new PdfPCell(new Paragraph(" ",secondFont));
	celld112.setBorder(Rectangle.NO_BORDER);
	celld212.setBorder(Rectangle.NO_BORDER);
	celld312.setBorder(Rectangle.NO_BORDER);
	celld112.setHorizontalAlignment(Element.ALIGN_LEFT);
	tabled.setHorizontalAlignment(Element.ALIGN_LEFT);
	tabled.addCell(celld112);
	tabled.addCell(celld212);
	tabled.addCell(celld312);
	
	PdfPCell celld113=new PdfPCell(new Paragraph(asmt3,secondFont));
	PdfPCell celld213=new PdfPCell(new Paragraph(" ",secondFont));
	PdfPCell celld313=new PdfPCell(new Paragraph(" ",secondFont));
	celld113.setBorder(Rectangle.NO_BORDER);
	celld213.setBorder(Rectangle.NO_BORDER);
	celld313.setBorder(Rectangle.NO_BORDER);
	celld313.setHorizontalAlignment(Element.ALIGN_LEFT);
	tabled.setHorizontalAlignment(Element.ALIGN_LEFT);
	tabled.addCell(celld113);
	tabled.addCell(celld213);
	tabled.addCell(celld313);
...
//TABLE E
	...
	//jpg1.setAbsolutePosition(40, 100); 
	//jpg1.scaleAbsolute(200, 150); 
	//jpg1.setRotationDegrees(0); 
	//document.add(jpg1);
	
	
	//jpg2.setAbsolutePosition(300, 100); 
	//jpg2.scaleAbsolute(200, 150); 
