...
// Set path based on county id parameter path --------------------------------------


// COUNTY-Wadena
if (cidp.equals("80")) {
	readerpath=("/reports/TAXSTMT2012C80.pdf");
}
else {
	readerpath=("/reports/TAXSTMT2012.pdf");
}
...
String query1=" SELECT * FROM [CNTYPRV] ";
query1+=" WHERE ((([CNTYPRV].SYCNTY)='"+cidp+"'))";
