...
Connection con1 = DriverManager.getConnection("jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ="+database2+"");
...
Connection con = DriverManager.getConnection("jdbc:odbc:Driver={Microsoft Access Driver (*.mdb, *.accdb)};DBQ="+database+"");
...
System.out.println("HERE WE ARE Before "+readerpath);
System.out.println(request.getRealPath(readerpath));
...
if (!cidp.equals("30"))  {
 ...
 if ((cidp.equals("30"))&& (twpnum.equals("65")))  {
 if (specialbal==None) {
