...
String database=("\\192.168.1.17\\Data\\NDWebTab"+cidp+".mdb");
String database2=("\\192.168.1.17\\Data\\cntyname.mdb");
...
Connection con1 = DriverManager.getConnection("jdbc:odbc:Driver={Microsoft Access Driver (*.mdb)};DBQ="+database2+"");
...
PdfReader reader = new PdfReader(request.getRealPath("/reports/ND232013STMT.pdf"));
...
AcroFields form = stamper.getAcroFields();
 ...
 while (rs.next()) {
	...
	if (second==None) {
 	...
 	String payments1="Payments can be made online thru Official Payments or Municipay";
 	String payments2="www.lamourecountynd.com, county office, treasurer or pay by";
 	String payments3="Phone 1-800-272-9829 code 4412.  A convinience fee will apply";
 	String payments4="using these methods of payment";
	...
	if (smfalco==None) {
 	...
 	statepaidcredit=statepaidcredit.trim();
 	String statepaidcreditbracket='('+statepaidcredit+')';
 	
 	String pdisc=rs.getString(121);
	pdisc=pdisc.trim();
 	String pdiscbracket='('+pdisc+')';

 	String psdisc=rs.getString(149);
	psdisc=psdisc.trim();
 	String psdiscbracket='('+psdisc+')';
...
// New Fields added 11/22/13
	...
	form.setField("pstpdcrdp2",rs.getString(171));
	form.setField("pstpdcrdpy",rs.getString(172));
	...
	form.setField("pstpdcrd1",statepaidcreditbracket);
...
// End add new fields	
	...
	form.setField("pdisc",pdiscbracket);
	...
	form.setField("psoffpay1",offpay1);
	form.setField("psoffpay2",offpay2);
	form.setField("psoffpay3",offpay3);
	form.setField("psoffpay4",offpay4);
