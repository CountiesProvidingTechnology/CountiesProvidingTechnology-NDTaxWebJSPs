...
String pdf21="/reports/MN21NOT2010.pdf";
String pdfxx="/reports/MNNOT2010.pdf";
String pdfinuse="";
...
AcroFields form = stamper.getAcroFields();
 ...
 System.out.println("IN RESULT LOOP");
	...
	if(mhflag.equals("0")) {
		...
		msg3="year 2010.  The property taxes you will pay in 2011";
		msg4="will be based on thsi valuation and classification.";
	...
	if (!mhflag.equals("0")) {
		msg1="This form is to notify you of the market value and";
		msg2="classification of your property for assessment";
		msg3="year 2010.  The property taxes you will pay in 2010";
		msg4="will be based on this valuation and classification.";
		Year1="(For Taxes Payable in 2009)";
		Year2="(For Taxes Payable in 2010)";
	}
