...
String query1=" SELECT * FROM [CNTYDATAP] ";
query1+=" WHERE ((([CNTYDATAP].SYCNTY)='"+cidp+"'))";
...
PdfReader reader = new PdfReader(request.getRealPath("/reports/ND232012STMT.pdf"));
...
AcroFields form = stamper.getAcroFields();
 ...
 while (rs.next()) {
	...
	if (second==None) {
 	...
 	String payments2="Via Phone: 800-272-9829 Enter code 4412; Via Internet: ndtreasurers.com";
