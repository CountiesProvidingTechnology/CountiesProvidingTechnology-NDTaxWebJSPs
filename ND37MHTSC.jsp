...
PdfReader reader = new PdfReader(request.getRealPath("/reports/ND372014MHTS.pdf"));
...
AcroFields form = stamper.getAcroFields();
 ...
 while (rs.next()) {
	...
	if (second==None) {
 	...
 	String payments2="Via Phone: 800-272-9829 Enter code 4418; Via Internet: ndtreasurers.com";
