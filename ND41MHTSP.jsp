...
PdfReader reader = new PdfReader(request.getRealPath("/reports/ND412013MHTS.pdf"));
...
//System.out.println("HERE WE ARE-2"+query);
 ...
 while (rs.next()) {
	...
	if (second==None) {
 	...
 	String payments2="Via Phone: 800-272-9829 Enter code 4407; Via Internet: ndtreasurers.com";
