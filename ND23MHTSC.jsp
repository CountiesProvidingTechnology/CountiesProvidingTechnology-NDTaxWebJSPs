...
PdfReader reader = new PdfReader(request.getRealPath("/reports/ND232013MHTS.pdf"));
...
AcroFields form = stamper.getAcroFields();
 ...
 while (rs.next()) {
	...
	if (second==None) {
 	...
 	String payments3="Phone 1-800-272-9829 code 4412.  A convenience fee will apply";
