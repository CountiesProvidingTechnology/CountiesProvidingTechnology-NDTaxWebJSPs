...
String zparcel="840026000";

String sketch11=zparcel+"0101.JPG";
String sketch12=zparcel+"0201.JPG";
String sketch21=zparcel+"0101-1.JPG";
String sketch22=zparcel+"0201-1.JPG";
...
jpg2=null;
try {
jpg2 = Image.getInstance("http://192.168.1.2/sketches/"+cntypath+"/"+sketch11+"");
} catch (IOException e) {
}

try {
jpg2 = Image.getInstance("http://192.168.1.2/sketches/"+cntypath+"/"+sketch21+"");
...
jpg3=null;
try {
jpg3 = Image.getInstance("http://192.168.1.2/sketches/"+cntypath+"/"+sketch12+"");
} catch (IOException e) {
}

try {
jpg3 = Image.getInstance("http://192.168.1.2/sketches/"+cntypath+"/"+sketch22+"");
} catch (IOException e1) {
}
...
rs3.close();
	...
	//jpg2.setAbsolutePosition(40, 100); 
